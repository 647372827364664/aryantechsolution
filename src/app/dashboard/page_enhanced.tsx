...
export default function DashboardPage() {
  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      const [ordersData, servicesData, alertsData, userProfileData, statsData] = await Promise.all([
        getUserOrders(firebaseUser.uid),
        getUserServices(firebaseUser.uid),
        getUserAlerts(firebaseUser.uid, 20),
        getUserProfile(firebaseUser.uid),
        getUserDashboardStats(firebaseUser.uid)
      ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900">
            Welcome back, {userProfile?.displayName || (user as any)?.displayName || 'User'}!
          </h2>
                ...
                {orders.length > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <Button className="mt-4">
                      <Link href="/services" className="text-white">Browse Services</Link>
                    </Button>
                  </div>
                )}
              </CardContent>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {alert.actionUrl && (
                            <Link 
                              ...
                              className="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors"
                            >
